...
var MinimalTheme = /** @class */ (function (_super) {
        ...
        switch (_b.label) {
          ...
          case 1:
            ...
            this.addCommand({
              ...
              callback: function () {
                _this.settings.darkStyle =
                  darkStyles[(darkStyles.indexOf(_this.settings.darkStyle) + 1) % darkStyles.length]
            ...
            this.addCommand({
              ...
              callback: function () {
                _this.settings.lightStyle =
                  lightStyles[(lightStyles.indexOf(_this.settings.lightStyle) + 1) % lightStyles.length]
                _this.saveData(_this.settings)
                _this.updateLightStyle()
              },
            })
  ...
  MinimalTheme.prototype.enableSystemTheme = function () {
    this.app.workspace.layoutReady
      ...
      : this.app.workspace.on('layout-ready', this.refreshSystemTheme)
  }
...
var MinimalSettingTab = /** @class */ (function (_super) {
  ...
  MinimalSettingTab.prototype.display = function () {
    ...
    containerEl.createEl('p', {
      text:
        'If you notice any issues, update to the latest version of Minimal Theme and reload Obsidian. Download the Hider plugin for additional options to further simplify the Obsidian UI.',
    })
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle.setValue(_this.plugin.settings.useSystemTheme).onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle.setValue(_this.plugin.settings.bordersToggle).onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle.setValue(_this.plugin.settings.focusMode).onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle.setValue(_this.plugin.settings.underlineInternal).onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle.setValue(_this.plugin.settings.underlineExternal).onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle.setValue(_this.plugin.settings.folding).onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle(function (toggle) {
        return toggle.setValue(_this.plugin.settings.relationLinesPreview).onChange(function (value) {
    ...
    new obsidian.Setting(containerEl)
      ...
      .setDesc('Show vertical lines that connect related bullet points and task lists')
      .addToggle(function (toggle) {
        return toggle.setValue(_this.plugin.settings.relationLinesEdit).onChange(function (value) {
    ...
    containerEl.createEl('p', {
      text:
        'These settings override the dropdowns above. Make sure to use the exact name of the font as it appears on your system.',
    })
    new obsidian.Setting(containerEl)
