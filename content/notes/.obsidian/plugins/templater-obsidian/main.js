...
This message will self-destruct in the next update.`
    new obsidian.Setting(containerEl).setName('Templater Update').setDesc(notice_fragment)
    ...
    new obsidian.Setting(containerEl).setName('Disables update Notice').addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.toggle_notice).onChange((toggle_notice) => {
    ...
    new obsidian.Setting(containerEl).setName('Internal Variables and Functions').setDesc(fragment)
    let i = 1
    ...
    let setting = new obsidian.Setting(containerEl).addButton((button) => {
  ...
  !(function (e, t) {
    ...
    function t(e) {
      var n,
        r,
        i = new Error(e)
      return (n = i), (r = t.prototype), Object.setPrototypeOf ? Object.setPrototypeOf(n, r) : (n.__proto__ = r), i
    }
    function n(e, n, r) {
      var i = n.slice(0, r).split(/\n/),
        a = i.length,
        o = i[a - 1].length + 1
      throw t(
        (e += ' at line ' + a + ' col ' + o + ':\n\n  ' + n.split(/\n/)[a - 1] + '\n  ' + Array(o).join(' ') + '^'),
    ...
    function a(e, t, n, r) {
      var i, a
      return (
        Array.isArray(t.autoTrim) ? ((i = t.autoTrim[1]), (a = t.autoTrim[0])) : (i = a = t.autoTrim),
        (n || !1 === n) && (i = n),
        (r || !1 === r) && (a = r),
        a || i
          ? 'slurp' === i && 'slurp' === a
    ...
    function f(e, t) {
      var r = [],
        ...
        s = t.parse
      if (t.plugins)
        for (var f = 0; f < t.plugins.length; f++) {
          ;(T = t.plugins[f]).processTemplate && (e = T.processTemplate(e, t))
        }
      function d(e, n) {
        e && (e = a(e, t, i, n)) && ((e = e.replace(/\\|'/g, '\\$&').replace(/\r\n|\n|\r/g, '\\n')), r.push(e))
      }
      ...
      for (
        var g,
          ...
          m = new RegExp('([^]*?)' + p(t.tags[0]) + '(-|_)?\\s*(' + h + ')?\\s*', 'g'),
          v = new RegExp('\'|"|`|\\/\\*|(\\s*(-|_)?' + p(t.tags[1]) + ')', 'g');
        (g = m.exec(e));
        ...
        for (var w = void 0, b = !1; (w = v.exec(e)); ) {
          if (w[1]) {
            ...
            ;(m.lastIndex = o = v.lastIndex),
              (i = w[2]),
              (b = { t: _ === s.exec ? 'e' : _ === s.raw ? 'r' : _ === s.interpolate ? 'i' : '', val: E })
            break
          }
          var I = w[0]
          if ('/*' === I) {
            var R = e.indexOf('*/', v.lastIndex)
            ;-1 === R && n('unclosed comment', e, w.index), (v.lastIndex = R)
          } else if ("'" === I) {
            ;(c.lastIndex = w.index), c.exec(e) ? (v.lastIndex = c.lastIndex) : n('unclosed string', e, w.index)
          } else if ('"' === I) {
            ;(u.lastIndex = w.index), u.exec(e) ? (v.lastIndex = u.lastIndex) : n('unclosed string', e, w.index)
          } else if ('`' === I) {
            ;(l.lastIndex = w.index), l.exec(e) ? (v.lastIndex = l.lastIndex) : n('unclosed string', e, w.index)
          }
        }
        b ? r.push(b) : n('unclosed tag', e, g.index + y.length)
      }
      if ((d(e.slice(o, e.length), !1), t.plugins))
        for (f = 0; f < t.plugins.length; f++) {
          var T
          ;(T = t.plugins[f]).processAST && (r = T.processAST(r, t))
        }
      return r
    }
    function d(e, t) {
            ...
            if (t.globalAwait) {
              for (n = 0; n < r; n++) {
                if ('string' != typeof (o = e[n]))
                  if ('r' === (s = o.t) || 'i' === s) i += 'prs.push(' + (l = o.val || '') + ');\n'
              }
            ...
            for (n = 0; n < r; n++) {
              ...
              if ('string' == typeof (o = e[n])) {
                ...
                var s = o.t,
                  l = o.val || ''
                'r' === s
                  ? (t.globalAwait && (l = 'rst[' + a + ']'),
                    t.filter && (l = 'E.filter(' + l + ')'),
                    (i += 'tR+=' + l + '\n'),
                    a++)
                  : 'i' === s
                  ? (t.globalAwait && (l = 'rst[' + a + ']'),
                    t.filter && (l = 'E.filter(' + l + ')'),
                    t.autoEscape && (l = 'E.e(' + l + ')'),
                    (i += 'tR+=' + l + '\n'),
                    a++)
                  : 'e' === s && (i += l + '\n')
              }
      ...
      if (t.plugins)
        for (var i = 0; i < t.plugins.length; i++) {
          var a = t.plugins[i]
          a.processFnString && (r = a.processFnString(r, t))
        }
      return r
    }
    var g = new ((function () {
    ...
    var h = {
      ...
      include: function (e, n) {
        var r = this.templates.get(e)
        if (!r) throw t('Could not fetch template "' + e + '"')
        return r(n, this)
      },
    ...
    function m(e, t) {
      var n = {}
      return i(n, h), t && i(n, t), e && i(n, e), n
    }
    function v(e, n) {
      var r = m(n || {}),
        i = r.async
    ...
    function y(e, t) {
      ...
      var n = 'function' == typeof e ? e : v(e, t)
      return t.cache && t.name && t.templates.define(t.name, n), n
    }
    function x(e, n, i, a) {
      var o = m(i || {})
      if (!o.async) return y(e, o)(n, o)
      if (!a) {
    ...
    ;(e.compile = v),
      ...
      (e.parse = f),
      (e.render = x),
      (e.renderAsync = function (e, t, n, r) {
        return x(e, t, Object.assign({}, n, { async: !0 }), r)
      }),
      (e.templates = g),
  ...
  generate_include() {
    return (include_filename) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        let parsed_content = yield this.plugin.parser.parseTemplates(
          inc_file_content,
          this.file,
          ContextMode.USER_INTERNAL,
        )
        InternalModuleFile.depth -= 1
...
class TemplaterPlugin extends obsidian.Plugin {
  onload() {
	...
	You can also find this message in the settings of Templater. This message will self-destruct in the next update. You can disable this notice in the settings.`
      ...
      this.addRibbonIcon('three-horizontal-bars', 'Templater', () =>
        __awaiter(this, void 0, void 0, function* () {
