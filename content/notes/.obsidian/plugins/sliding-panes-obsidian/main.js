        ...
        var mouseup_1 = function () {
          ...
          if (_this.settings.stackingEnabled) {
            ...
            leaf.containerEl.style.right =
              (leafCount - leafIndex - 1) * _this.settings.headerWidth - leaf.containerEl.clientWidth + 'px'
          }
    ...
    if (activeLeaf != null && this.rootSplit) {
      ...
      // it's too far right
        ...
        rootContainerEl.scrollTo({
          left: position_1 + activeLeaf.containerEl.clientWidth + headersToRightWidth - rootContainerEl.clientWidth,
          top: 0,
