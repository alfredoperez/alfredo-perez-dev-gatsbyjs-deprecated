...
module.exports = {
  ...
  variants: {
    ...
    backgroundImage: ['responsive', 'group-hover', 'hover', 'before', 'after'],
    ...
    borderColor: ['active', 'hover', 'focus', 'before', 'after', 'group-hover'],
    borderWidth: ['hover', 'focus', 'active', 'hover', 'focus', 'before', 'after', 'last'],
  },
